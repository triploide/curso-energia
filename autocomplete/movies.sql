...
-- Volcando estructura de base de datos para movies
CREATE DATABASE IF NOT EXISTS `movies` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `movies`;

-- Volcando estructura para tabla movies.actors
...
-- Volcando datos para la tabla movies.actors: ~49 rows (aproximadamente)
DELETE FROM `actors`;
...
-- Volcando estructura para tabla movies.actor_episode
...
-- Volcando datos para la tabla movies.actor_episode: ~148 rows (aproximadamente)
...
-- Volcando estructura para tabla movies.actor_movie
...
-- Volcando datos para la tabla movies.actor_movie: ~43 rows (aproximadamente)
...
-- Volcando estructura para tabla movies.episodes
...
-- Volcando datos para la tabla movies.episodes: ~57 rows (aproximadamente)
...
-- Volcando estructura para tabla movies.genres
...
-- Volcando datos para la tabla movies.genres: ~12 rows (aproximadamente)
DELETE FROM `genres`;
...
-- Volcando estructura para tabla movies.migrations
...
-- Volcando datos para la tabla movies.migrations: ~10 rows (aproximadamente)
...
-- Volcando estructura para tabla movies.movies
...
-- Volcando datos para la tabla movies.movies: ~21 rows (aproximadamente)
DELETE FROM `movies`;
...
-- Volcando estructura para tabla movies.password_resets
...
-- Volcando datos para la tabla movies.password_resets: ~0 rows (aproximadamente)
DELETE FROM `password_resets`;
/*!40000 ALTER TABLE `password_resets` DISABLE KEYS */;
/*!40000 ALTER TABLE `password_resets` ENABLE KEYS */;

-- Volcando estructura para tabla movies.seasons
...
-- Volcando datos para la tabla movies.seasons: ~46 rows (aproximadamente)
DELETE FROM `seasons`;
...
-- Volcando estructura para tabla movies.series
...
-- Volcando datos para la tabla movies.series: ~6 rows (aproximadamente)
DELETE FROM `series`;
...
-- Volcando estructura para tabla movies.users
...
-- Volcando datos para la tabla movies.users: ~0 rows (aproximadamente)
DELETE FROM `users`;
